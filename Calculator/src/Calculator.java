...
public class Calculator implements ActionListener, KeyListener{
    ...
    ImageIcon icon = new ImageIcon("resources/stayOnTop.png");
    ImageIcon icon2 = new ImageIcon("resources/onTop.png");
    JButton pwrButton = new JButton();
    ImageIcon bsIcon = new ImageIcon("resources/backspace.png");
	...
	public static void main(String[] args) {
		...
		calc.getClass(); //only here to make it not show calc as unused
